...
use App\Http\Controllers\Api\User\DeleteFavoritePlaceController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::delete('user/places/{place}/favorite', DeleteFavoritePlaceController::class);
});
...
Route::get('places/{place}/related', RelatedPlaceController::class);
